...
int main(int argc, char* argv[])
{
   ...
   // UDT::setsockopt(client, 0, UDT_CC, new CCCFactory<CBBR4>, sizeof(CCCFactory<CBBR4>));
   ...
   // UDT::setsockopt(client, 0, UDT_RCVBUF, new int(40000000), sizeof(int));
   // UDT::setsockopt(client, 0, UDP_RCVBUF, new int(40000000), sizeof(int));
   ...
   */
   ...
   uint64_t data_num = atoi(argv[3]) * 200;
